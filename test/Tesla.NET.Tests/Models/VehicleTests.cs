...
namespace Tesla.NET.Models
{
    ...
    public class When_serializing_Vehicle_Should_serialize : FixtureContext
    {
        ...
        [Fact]
        public void tokens() =>
            _json["tokens"].Select(t => t.Value<string>())
                .ShouldAllBeEquivalentTo(_sut.Tokens, config => config.WithStrictOrdering());
    ...
    public class When_deserializing_Vehicle_Should_deserialize
    {
        private readonly Vehicle _sut;
        private readonly JObject _json;
        ...
        [Fact]
        public void tokens() =>
            _sut.Tokens.ShouldAllBeEquivalentTo(
                _json["tokens"].Select(t => t.Value<string>()), config => config.WithStrictOrdering());
